...
class MyCustom3DSegDataset(Dataset):
    ...
    def __init__(self,
        ...
        if self.ann_file is not None:#only modify this
        ...
        self.CLASSES, self.PALETTE = \
            self.get_classes_and_palette(classes, palette) #eval需要
    ...
    def _extract_data(self, index, pipeline, key, load_annos=False):
        ...
        if load_annos:
            original_test_mode = self.test_mode #TODO check the usage of test_
